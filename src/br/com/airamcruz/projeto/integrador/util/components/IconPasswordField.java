...
public class IconPasswordField extends JPasswordField {
	...
	private static final long serialVersionUID = 3518087663637668415L;
	...
	public IconPasswordField(String name, int x, int y, int width, int height) {
	...
	public void paintComponent(Graphics g) {
		...
		//g.drawImage(img, 5, 3, width, height, this);
