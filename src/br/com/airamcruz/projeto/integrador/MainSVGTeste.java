...
public class MainSVGTeste extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MainSVGTeste frame = new MainSVGTeste();
	...
	public MainSVGTeste() {
		...
		svg001.setSVGIcon(getClass().getClassLoader().getResource("resource/image/user-add.svg"), 200, 200);
		
		//svg002.setSVGIcon(getClass().getClassLoader().getResource("user-add.svg"), 100, 100);
	}
}
